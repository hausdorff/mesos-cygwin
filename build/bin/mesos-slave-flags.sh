...
export MESOS_LAUNCHER_DIR=/home/aclemmer/src/mesos/build/src
...
if test $(uname) = 'Darwin'; then
  MESOS_NATIVE_JAVA_LIBRARY=/home/aclemmer/src/mesos/build/src/.libs/libmesos-0.23.0.dylib
  MESOS_NATIVE_LIBRARY=/home/aclemmer/src/mesos/build/src/.libs/libmesos-0.23.0.dylib
else
  MESOS_NATIVE_JAVA_LIBRARY=/home/aclemmer/src/mesos/build/src/.libs/libmesos-0.23.0.so
  MESOS_NATIVE_LIBRARY=/home/aclemmer/src/mesos/build/src/.libs/libmesos-0.23.0.so
fi

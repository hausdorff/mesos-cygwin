...
. /home/aclemmer/src/mesos/build/../support/colors.sh
...
LIBTOOL=/home/aclemmer/src/mesos/build/libtool
...
. /home/aclemmer/src/mesos/build/bin/mesos-master-flags.sh

exec ${LIBTOOL} --mode=execute valgrind --tool=${VALGRINDTOOL} \
  /home/aclemmer/src/mesos/build/src/mesos-master "${@}"
